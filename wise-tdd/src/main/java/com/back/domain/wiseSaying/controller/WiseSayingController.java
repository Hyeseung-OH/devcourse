...
public class WiseSayingController {
    ...
    public void actionList(Rq rq) {
        ...
        PageDto pageDto = wiseSayingService.findListDesc(kw, kwdType, pageSize, page);
        ...
        System.out.println("----------------------");
        // 페이지 정보 출력
        // 페이지 개수 => 전체 개수 / 페이지 사이즈, ex) total 10개, size 5개 => 2개의 페이지 개수가 필요
