...
public class AnswerController {
    ...
    public String createAnswer(Model model, @PathVariable("id") Integer id,
        ...
        if (bindingResult.hasErrors()) {
            ...
            // 에러 발생 시에도 페이징 정보 전달 (기본값으로)
            Page<Answer> answerPaging = this.answerService.getAnswerList(question, 0, "latest");
    ...
    public String answerDelete(Principal principal, @PathVariable("id") Integer id,
        ...
        return String.format("redirect:/question/detail/%s?page=%d&sort=%s", 
                answer.getQuestion().getId(), page, sort);
    }
    ...
    public String answerVote(Principal principal, @PathVariable("id") Integer id,
        ...
        return String.format("redirect:/question/detail/%s?page=%d&sort=%s#answer_%s", 
                answer.getQuestion().getId(), page, sort, answer.getId());
    }
}
